...
<body>
    ...
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/ProductPhotoServlet" enctype="multipart/form-data">
		...
		<input type="submit" value="新增" name="Update">
...
<table border='1' bordercolor='#CCCCFF' width="100%" style="table-layout:fixed">
	...
	<c:forEach var="photo" items="${photos}">
		<tr align='center' valign='middle'>
			...
			<td>
			  <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/ProductPhotoServlet">
			     <input type="submit" value="刪除" name="Update">
			     <input type="hidden" value="${photo.photo_id}" name="photoid">
			      <input type="hidden" value="${param.productId}" name="productId">
			  </FORM>
			</td>
		</tr>
