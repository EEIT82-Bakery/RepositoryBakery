					...
					<div class="profile-sidebar">
						...
						<div class="profile-usermenu">
							<ul class="nav">
								...
								<c:if test="${not empty isLogin}">	
								<c:if test="${isLogin.member_id==member.member_id}">			
								<li><a href="${pageContext.request.contextPath}/MessageServlet.do?action=select&pages=1"
									target="_blank"><i class="glyphicon glyphicon-envelope"></i>我的信箱</a>
								</li>
								</c:if>
								</c:if>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <div class="text-center">
            <button type="submit" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-send"></span> 送出</button>
