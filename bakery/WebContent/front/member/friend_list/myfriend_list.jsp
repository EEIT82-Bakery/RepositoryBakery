...
<!-- 						<h2 class="ui dividing header">我的好友</h2> -->
<!-- 						<div class="right aligned"> -->
<%-- 						<form method="post" action="${pageContext.request.contextPath}/Friend_ListServlet" class="ui form"> --%>
<!-- 							<div class="inline fields"> -->
<!-- 								<div class="field"> -->
<!-- 									<input type="email" name="mem_acc" placeholder="請輸入該會員帳號"> -->
<!-- 								</div> -->
<!-- 								<div class="field"> -->
<!-- 									<input class="ui primary small button" type="submit" value="搜尋會員"> -->
<!-- 								</div> -->
<!-- 							</div> -->
<!-- 							<input type="hidden" name="action" value="getOneByAcc"> -->
