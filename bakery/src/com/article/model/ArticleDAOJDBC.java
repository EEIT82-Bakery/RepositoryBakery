...
public class ArticleDAOJDBC implements ArticleDAO_interface {
	...
	@Override
	public List<ArticleBean> getPageArticles(int startRecordNo, int endRecordNo) {
		// TODO Auto-generated method stub
		return null;
	}
	@Override
	...
	@Override
	public List<ArticleBean> getPageArticlesClass(int articleClassNo, int startRecordNo, int endRecordNo) {
		// TODO Auto-generated method stub
		return null;
	}
	...
	@Override
	public void updateArticleHidden(int hidden, int articleId , int memberId) {
		// TODO Auto-generated method stub
